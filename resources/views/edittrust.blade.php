    ...
    <div class="flex items-center justify-center" id="responsiveForm">
        <div class="space-y-10 divide-y divide-gray-900/10 p-5 m-50 card">
            <div class="bg-white rounded-md shadow-md p-6 lg:w-full lg:p-8">
                <form method='POST' action="/edittrust/{{$trust->id}}">
                    @csrf
                    @method('patch')
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 py-5">
                        <div class="">
                            ...
                            <input type="text" id="site_id" name="site_id"
                                ...
                                autocomplete="trust_name" placeholder="Enter site Id" value="{{$trust->site_id}}">
                        </div>
                        ...
                        <div class="relative col-span-2">
                            ...
                            <div class="flex">
                                <select name="trust_name" id="select_trust_name"
                                    ...
                                    title="Select trust...">
                                    <option value="{{$trust->trust_name}}">{{$trust->trust_name}}</option>
                                ...
                                <input type="text" id="input_trust_name" 
                                    ...
                                    autocomplete="trust_name" placeholder="Enter Trust Name" value="{{$trust->trust_name}}">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4 py-5">
                        <div class="col-span-2">
                            ...
                            <input type="text" id="site_name" name="site_name"
                                ...
                                autocomplete="site_name" placeholder="Enter site Name" value="{{$trust->site_name}}">
                        </div>
                    </div>
                        ...
                        <div class="relative">
                            ...
                            <div class="flex">
                                <select name="country" id="select_country"
                                    ...
                                    <option value="{{$trust->country}}">{{$trust->country}}</option>
                                ...
                                <input type="text" id="input_coutry_name"
                                    class="hidden block w-full rounded-md border-0 py-1.5 text-gray-600 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                                    autocomplete="country" placeholder="Enter Country Code or Name" value="{{$trust->country}}">
                        ...
                        <div class="relative">
                            ...
                            <div class="flex">
                                ...
                                <input type="text" id="input_state_name" 
                                    class="hidden block w-full rounded-md border-0 py-1.5 text-gray-600 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                                    autocomplete="state" placeholder="Enter State Code or Name" value="{{$trust->state}}">
                        ...
                        <div class="relative">
                            ...
                            <div class="flex">
                                ...
                                <input type="text" id="input_city_name" 
                                    class="hidden block w-full rounded-md border-0 py-1.5 text-gray-600 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                                    autocomplete="city" placeholder="Enter city Code or Name" value="{{$trust->city}}">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 py-5">
                        <div class="">
                            ...
                            <input type="date" id="start_date" name="start_date"
                                class="block w-full rounded-md border-0 py-1.5 text-gray-600 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                                autocomplete="start_date" value="{{$trust->start_date}}">
                        </div>
                        <div class="">
                            ...
                            <input type="date" id="end_date" name="end_date"
                                class="block w-full rounded-md border-0 py-1.5 text-gray-600 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                                autocomplete="end_date" value="{{$trust->end_date}}">
                        </div>
                        <div class="">
                            ...
                            <input type="date" id="added_date" name="added_date"
                                class="block w-full rounded-md border-0 py-1.5 text-gray-600 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                                autocomplete="added_date" value="{{$trust->added_date}}">
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 py-5">
                        <div class="">
                            ...
                            <input type="text" id="entity" name="entity"
                                class="block w-full rounded-md border-0 py-1.5 text-gray-600 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                                autocomplete="entity" placeholder="Enter Entity Name" value="{{$trust->entity}}">
                        </div>
                        <div class="col-span-2">
                            ...
                            <input type="text" id="location_info" name="location_info"
                                class="block w-full rounded-md border-0 py-1.5 text-gray-600 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                                autocomplete="location_info" placeholder="Enter location info" value="{{$trust->location_info}}">
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 py-5">
                        <div class="">
                            ...
                            <input type="text" id="address" name="address"
                                class="block w-full rounded-md border-0 py-1.5 text-gray-600 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                                autocomplete="address" placeholder="Enter address" value="{{$trust->address}}">
                        </div>
                        <div class="">
                            ...
                            <input type="text" id="occupation" name="occupation"
                                class="block w-full rounded-md border-0 py-1.5 text-gray-600 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                                autocomplete="occupation" placeholder="Enter Occupation" value="{{$trust->occupation}}">
                        </div>
                        ...
                        <div class=" ">
                            ...
                            <select id="doc_req" name="doc_req" autocomplete="doc_req"
                                class="block w-full rounded-md border-0 py-1.5 text-gray-600 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                                <option value="{{$trust->doc_req}}">{{$trust->doc_req}}</option>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 py-5">
                        ...
                        <div class=" ">
                            ...
                            <select id="change_since_last_month" name="change_since_last_month"
                                ...
                                class="block w-full rounded-md border-0 py-1.5 text-gray-600 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                                <option value="{{$trust->change_since_last_month}}">{{$trust->change_since_last_month}}</option>
                                <option value="true">True</option>
                                <option value="false">False</option>
                            </select>
                        </div>
                        ...
                        <div class="">
                            ...
                            <input type="text" id="employer" name="employer"
                                class="block w-full rounded-md border-0 py-1.5 text-gray-600 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                                autocomplete="employer" placeholder="Enter Employer" value="{{$trust->employer}}">
                        </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 py-5">
                        ...
                        <div class="col-span-2">
                            ...
                            <textarea type="text" id="remark" name="remark"
                                class="block w-full rounded-md border-0 py-1.5 text-gray-600 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                                autocomplete="remark" placeholder="Enter remark">{{$trust->remark}}</textarea>
                        </div>
